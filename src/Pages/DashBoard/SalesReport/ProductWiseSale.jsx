...
import { ProductWiseSaleData } from "../../../assets/data";
          ...
          >
            ...
            <div className="AllabsAssets">
              ...
              <span className="filterLinks ColorChangeFilterLink">
                Orange <span className="NewChangeColor">(6)</span>
              </span>
              <span className="filterLinks ColorChangeFilterLink">
                Cocacoal <span className="NewChangeColor">(17)</span>
              </span>
              <span className="filterLinks ColorChangeFilterLink">
                Icecream <span className="NewChangeColor">(6,810)</span>
              </span>
            </div>
