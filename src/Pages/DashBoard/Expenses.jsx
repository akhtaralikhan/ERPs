                        ...
                        <div className="card-body border-bottom">
                          ...
                          >
                                ...
                                <tbody className="list">
                                  <tr>
                                    <td className="align-middle ps-3 name">
                                      <a href="#">Mar 31, 2023, 12:41</a>
                                    </td>
                                    <td className="align-middle">N/A</td>
                                    <td className="align-middle">American bank</td>
                                    ...
                                    <td className="align-middle">Inventory</td>
                            ...
                            <div className="d-flex justify-content-between mt-3">
                              ...
                              >
                                1 to 5 <span className="text-600"> Items of </span>
                                43
                              </span>
                    ...
                    <div className="modal-body">
                      ...
                      <div className="mb-3">
                        ...
                        <button
                          ...
                          type="button"
                        >
                          <i className="fa fa-solid fa-plus me-2"></i> New Category
                        </button>
                      </div>
                      <div className="mb-3">
                        <label className="form-label" htmlFor="inputtext">
