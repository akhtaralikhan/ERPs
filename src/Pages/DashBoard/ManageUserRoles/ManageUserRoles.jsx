...
import { ManageUserData } from "../../../assets/data";
import ManageUserRolesModal from "../../../Components/ManageUserRolesModal";
import ManageUserRolesViewModal from "../../../Components/ManageUserRolesViewModal";
                        ...
                        <div className="font-sans-serif btn-reveal-trigger position-static p-0">
                          ...
                          <div className="dropdown-menu dropdown-menu-end py-2">
                            <Link
                              ...
                              type="button"
                              data-bs-toggle="modal"
                              data-bs-target="#manageUserRolesModal" // 🔹 use the correct modal ID
                              onClick={() => {
                                setMode("edit");
                            ...
                            <Link
                              ...
                              to="#!"
                              data-bs-toggle="modal"
                              data-bs-target="#manageUserRolesViewModal"
