          ...
          <div className="p-3 row MainRemovePaddingwidth pb-2" style={{ minWidth: "170px" }}>
            ...
            >
              ...
              <span className="filterLinks ColorChangeFilterLink">
                Item Name <span className="NewChangeColor">(6)</span>
              </span>
              <span className="filterLinks ColorChangeFilterLink">
                Location <span className="NewChangeColor">(17)</span>
              </span>
              <span className="filterLinks ColorChangeFilterLink">
            ...
            <div className="d-flex align-items-center">
              ...
              {showModal && <AddWarehouseModal showModal={showModal} setShowModal={setShowModal} />}
            </div>
          </div>
