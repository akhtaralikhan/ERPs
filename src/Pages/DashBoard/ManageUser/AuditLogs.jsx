...
import { AuditLogsData } from "../../../assets/data";
...
const AuditLogs = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      { Header: "Primary Key", accessor: "PrimaryKey" },
    ],
    []
  );
          ...
          >
            ...
            <div className="AllabsAssets pt-1">
              ...
              <span className="filterLinks ColorChangeFilterLink">
                Create <span className="NewChangeColor">(6)</span>
              </span>
              <span className="filterLinks ColorChangeFilterLink">
                Update <span className="NewChangeColor">(17)</span>
              </span>
              <span className="filterLinks ColorChangeFilterLink">
                Payment <span className="NewChangeColor">(6,810)</span>
              </span>
            </div>
