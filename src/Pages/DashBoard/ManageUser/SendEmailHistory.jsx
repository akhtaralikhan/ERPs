...
import { SendEmailHistoryData } from "../../../assets/data";
import SendEmailHistoryViewModal from "../../../Components/SendEmailHistoryViewModal";
...
const SendEmailHistory = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      { Header: "Receiver Email", accessor: "ReceiverEmail" },
          ...
          >
            ...
            <div className="AllabsAssets">
              ...
              <span className="filterLinks ColorChangeFilterLink">
                Send <span className="NewChangeColor">(6)</span>
              </span>
              <span className="filterLinks ColorChangeFilterLink">
                Failed <span className="NewChangeColor">(17)</span>
              </span>
              <span className="filterLinks ColorChangeFilterLink">
                        ...
                        <div className="font-sans-serif btn-reveal-trigger position-static p-0">
                          ...
                          <div className="dropdown-menu dropdown-menu-end py-2">
                            <Link
                              ...
                              data-bs-target="#SendEmailHistoryViewModal"
