...
import { UserInfoFromBrowserData } from "../../../assets/data";
import UserInfoFromBrowserModal from "../../../Components/UserInfoFromBrowserModal";
import UserInfoFromBrowserModalAddEdit from "../../../Components/UserInfoFromBrowserModalAddEdit";

const UserInfoFromBrowser = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      { Header: "Browser Unique ID", accessor: "BrowserUniqueID" },
      { Header: "Lat", accessor: "Lat" },
      { Header: "Long", accessor: "Long" },
      { Header: "Time Zone", accessor: "TimeZone" },
      { Header: "Browser Major", accessor: "BrowserMajor" },
          ...
          >
            ...
            <div className="AllabsAssets">
              ...
              <span className="filterLinks ColorChangeFilterLink">
                Chrome <span className="NewChangeColor">(6)</span>
              </span>
              <span className="filterLinks ColorChangeFilterLink">
                Firefox <span className="NewChangeColor">(17)</span>
              </span>
              <span className="filterLinks ColorChangeFilterLink">
                Safari <span className="NewChangeColor">(6,810)</span>
              </span>
            </div>
            ...
            <div className="">
              ...
              <button
                ...
                data-bs-target="#UserInfoFromBrowserModalAddEdit"
                onClick={() => {
                  setMode("new");
                  setEditData(null);
                }}
                        ...
                        <div className="font-sans-serif btn-reveal-trigger position-static p-0">
                          ...
                          <div className="dropdown-menu dropdown-menu-end py-2">
                            <Link
                              ...
                              type="button"
                              data-bs-toggle="modal"
                              data-bs-target="#userInfoFromBrowserModal"
...
export default UserInfoFromBrowser;
