...
import { SummaryReportData } from "../../../assets/data";
...
const SummaryReport = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      { Header: "Sales Total", accessor: "SalesTotal" },
      { Header: "Sales Paid Total", accessor: "SalesPaidTotal" },
      { Header: "Sales Due Total", accessor: "SalesDueTotal" },
      { Header: "Purchases Total", accessor: "PurchasesTotal" },
      { Header: "Purchases Paid Total", accessor: "PurchasesPaidTotal" },
      { Header: "Purchases Due Total", accessor: "PurchasesDueTotal" },
      { Header: "Expense Total", accessor: "ExpenseTotal" },
      { Header: "Expense Paid Total", accessor: "ExpensePaidTotal" },
      { Header: "Expense Due Total", accessor: "ExpenseDueTotal" },
    ],
    []
  );
