...
import { emailConfigs } from "../../../assets/data";
import GlobalFilter from "../../../Components/GlobalFilter";
import AddEmailConfigModal from "../../../Components/Modals/AddEmailConfigModal";
            ...
            <div className="avatar avatar-l">
              {row.original.CoverImage ? (
                ...
                <div className="avatar-name rounded-circle avatar-m">
                  <span>{row.original.email?.[0]}</span>
                </div>
              )}
            </div>
            <div>
          ...
          <div className=" p-3 row" style={{ minWidth: "170px" }}>
            ...
            >
              ...
              <span className="filterLinks ColorChangeFilterLink">
                Email Id <span className="NewChangeColor">(6)</span>
              </span>
              <span className="filterLinks ColorChangeFilterLink">
            ...
            <div className="">
              ...
              {showModal && <AddEmailConfigModal showModal={showModal} setShowModal={setShowModal} />}
            </div>
          </div>
