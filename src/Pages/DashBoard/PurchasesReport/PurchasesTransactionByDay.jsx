...
import { PurchasesTransactionByDayData } from "../../../assets/data";

const PurchasesTransactionByDay = () => {
  ...
  const columns = useMemo(
    () => [
      { Header: "SL", accessor: "SL", size: 400 },
      {
        ...
        accessor: "Date",
        Cell: ({ value }) => {
          if (!value) return ""; // ✅ keep totals row empty
      ...
      { Header: "Total Trans", accessor: "TotalTrans" },
      { Header: "Total Earned", accessor: "TotalEarned" },
  ...
  const {
    ...
    {
      columns,
      data: PurchasesTransactionByDayData,
    },
    useGlobalFilter,
    useSortBy
  );
...
export default PurchasesTransactionByDay;
