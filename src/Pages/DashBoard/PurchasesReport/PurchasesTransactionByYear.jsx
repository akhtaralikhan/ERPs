...
import { PurchasesTransactionByYearData } from "../../../assets/data";

const PurchasesTransactionByYear = () => {
  ...
  const {
    ...
    {
      columns,
      data: PurchasesTransactionByYearData,
    },
    useGlobalFilter,
    useSortBy
  );
...
export default PurchasesTransactionByYear;
