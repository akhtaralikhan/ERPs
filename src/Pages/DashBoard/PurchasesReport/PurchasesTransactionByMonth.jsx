...
import { PurchasesTransactionByMonthData } from "../../../assets/data";

const PurchasesTransactionByMonth = () => {
  ...
  const {
    ...
    {
      columns,
      data: PurchasesTransactionByMonthData,
    },
    useGlobalFilter,
    useSortBy
  );
        ...
        <div className="NewColorChange phoenix-toolbar d-flex align-items-center flex-wrap py-md-3 px-md-4 mb-md-0 border-bottom gap-3">
          <div className="p-3 row PrintSize" style={{ minWidth: "170px" }}>
            <h2
              ...
              style={{ fontSize: "2rem" }}
            >
              Purchases Transaction By Month
            </h2>
...
export default PurchasesTransactionByMonth;
