...
const basePrivateRoutes = [
  ...
  { path: "/BusinessERP/Index", component: <DashboardHome /> },
  // POS
  ...
  { path: "/ManageSupplier", component: <ManageSupplier /> }, // NOT THAT GOOD 
...
if (superAdmin) {
  basePrivateRoutes.push({ path: "/UserProfile/Index", component: <Console /> });
}
